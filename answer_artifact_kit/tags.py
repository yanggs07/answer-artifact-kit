...
class AnswerTagsArtifact:
    def __init__(self, source_url, tags, prompt_template=DEFAULT_TAG_PROMPT_TEMPLATE, meta_json=None):
        self.source_url = source_url
        self.tags = normalize_tags(tags)
        self.prompt_template = prompt_template
        self.meta_json = meta_json
        self.answer = AnswerCaseArtifact.from_url(source_url, "", meta_json=meta_json)
...
def run_tags_cli_from_url(source_url, tags, prompt_template=DEFAULT_TAG_PROMPT_TEMPLATE, meta_json=None, argv=None):
